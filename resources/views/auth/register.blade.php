...
<body class="h-full bg-white text-gray-900 antialiased dark:bg-gray-900 dark:text-white">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white dark:bg-gray-900 w-full lg:w-[45%]">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                
                <div class="mb-8 ">
                    <div class="flex items-center  gap-3 mb-6">
                        <img src="{{ asset('images/logo/rit-dark-logo.svg') }}" 
                             alt="Logo RIT" 
                             class="h-12 w-auto">
                    </div>
                ...
                <div class="mt-6">
                    <form action="{{ route('register') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            <label for="name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300">Nama Lengkap</label>
                            <div class="relative mt-2">
                                ...
                                <input id="name" name="name" type="text" value="{{ old('name') }}" required placeholder="Nama Mahasiswa"
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300">Email Kampus/Pribadi</label>
                            <div class="relative mt-2">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                ...
                                <input id="email" name="email" type="email" value="{{ old('email') }}" required placeholder="email@contoh.com"
                                    class="block w-full rounded-xl border-0 bg-gray-50 py-3 pl-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[#3C50E0] sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:text-white dark:focus:bg-gray-800 transition-all duration-200">
                            </div>
                        </div>

                        <div>
                            <label for="npm" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300">NPM</label>
                            <div class="relative mt-2">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <input id="npm" name="npm" type="text" value="{{ old('npm') }}" required placeholder="Contoh: 20234359123" oninput="this.value = this.value.replace(/[^0-9]/g,'');"
                                    class="block w-full rounded-xl border-0 bg-gray-50 py-3 pl-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[#3C50E0] sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:text-white dark:focus:bg-gray-800 transition-all duration-200">
                            </div>
                        </div>

                        <div>
                            <label for="no_hp" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300">No. Handphone (WA)</label>
                            <div class="relative mt-2">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M5.55025 3.02941C5.10931 3.47035 4.90802 3.82958 4.79373 4.24021C4.65997 4.7208 4.67396 5.25337 4.90999 6.27546C5.39726 8.38573 6.64998 10.6875 8.78672 12.8242C10.9235 14.961 13.2252 16.2137 15.3355 16.701C16.3576 16.937 16.8901 16.951 17.3707 16.8172C17.7814 16.7029 18.1406 16.5016 18.5815 16.0607L18.7779 15.8643C19.074 15.5681 19.074 15.088 18.7779 14.7918L16.2082 12.2222C15.912 11.926 15.4318 11.926 15.1357 12.2222L14.5936 12.7642C14.4759 12.8819 14.3093 12.9375 14.1466 12.8986C13.8821 12.8354 13.3592 12.7001 12.593 12.2319C11.8335 11.7678 11.0269 11.0991 10.1876 10.2598C9.34825 9.42045 8.67958 8.61389 8.21542 7.85437C7.74722 7.2882 7.61191 6.76532 7.54874 6.5008C7.5098 6.33808 7.56543 6.17148 7.68316 6.05375L8.22513 5.51178C8.52134 5.21557 8.52134 4.73542 8.22513 4.43921L5.65546 1.86954C5.35925 1.57333 4.8791 1.57333 4.58289 1.86954L4.38645 2.06598L5.55025 3.02941ZM4.38645 2.06598L5.55025 3.02941L4.38645 2.06598Z" />
                                    </svg>
                                </div>
                                <input id="no_hp" name="no_hp" type="text" value="{{ old('no_hp') }}" required placeholder="0812xxxxxxxx" oninput="this.value = this.value.replace(/[^0-9]/g,'');"
                                    class="block w-full rounded-xl border-0 bg-gray-50 py-3 pl-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[#3C50E0] sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:text-white dark:focus:bg-gray-800 transition-all duration-200">
                            </div>
                        </div>
                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative mt-2">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clip-rule="evenodd" /></svg>
                                </div>
                                <input :type="show ? 'text' : 'password'" id="password" name="password" required placeholder="Minimal 8 karakter"
                                ...
                                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none cursor-pointer">
                        ...
                        <div x-data="{ show: false }">
                            <label for="password_confirmation" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300">Konfirmasi Password</label>
                            <div class="relative mt-2">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 1a4.5 4.5 0 00-4.5 4.5V9H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-.5V5.5A4.5 4.5 0 0010 1zm3 8V5.5a3 3 0 10-6 0V9h6z" clip-rule="evenodd" /></svg>
                                </div>
                                <input :type="show ? 'text' : 'password'" id="password_confirmation" name="password_confirmation" required placeholder="Ulangi password di atas"
                                    class="block w-full rounded-xl border-0 bg-gray-50 py-3 pl-10 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-[#3C50E0] sm:text-sm sm:leading-6 dark:bg-gray-800 dark:ring-gray-700 dark:text-white dark:focus:bg-gray-800 transition-all duration-200">
                        ...
                        <div>
                            <button type="submit" class="flex w-full justify-center rounded-xl bg-[#3C50E0] px-3 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-500/30 hover:bg-[#3243be] hover:shadow-blue-500/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3C50E0] transition-all duration-200">
                                Daftar Sekarang
                            </button>
                        </div>
                    </form>
                    ...
                    <p class="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
                        Sudah memiliki akun?
                        <a href="{{ route('login') }}" class="font-semibold text-[#3C50E0] hover:text-blue-500 transition-colors">
                            Masuk di sini
                        </a>
                    </p>
                </div>
        ...
        <div class="relative hidden w-0 flex-1 lg:block bg-gray-900 overflow-hidden" 
            ...
            <template x-for="(slide, index) in slides" :key="index">
                <div x-show="activeSlide === index" 
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-[#3C50E0] via-gray-900/40 to-gray-900/20 mix-blend-multiply"></div>
                </div>
            </template>
