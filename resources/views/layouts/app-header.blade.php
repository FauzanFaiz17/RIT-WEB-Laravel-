    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="/images/logo/rit-dark-logo.svg" alt="Logo" width="220" height="220"/>
                <img class="hidden dark:block" src="/images/logo/rit-white-logo.svg" alt="Logo" width="220" height="220" />
            </a>
