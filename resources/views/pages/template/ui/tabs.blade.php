...
@section('content')
    ...
    <div class="p-3 border border-gray-200 rounded-t-xl dark:border-gray-800">
        ...
        <nav class="flex overflow-x-auto rounded-lg bg-gray-100 p-1 dark:bg-gray-900 [&amp;::-webkit-scrollbar]:h-1.5 [&amp;::-webkit-scrollbar-track]:bg-white dark:[&amp;::-webkit-scrollbar-track]:bg-transparent [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-200 dark:[&amp;::-webkit-scrollbar-thumb]:bg-gray-600">
                        ...
                        'bg-white text-gray-900 shadow-sm dark:bg-white/[0.03] dark:text-white': activeTab === 'overview',
                        'bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200': activeTab !== 'overview'
                    }" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-white text-gray-900 shadow-sm dark:bg-white/[0.03] dark:text-white">
                    Overview
                </button>
                            <button @click="activeTab = 'notification'" :class="{
                        'bg-white text-gray-900 shadow-sm dark:bg-white/[0.03] dark:text-white': activeTab === 'notification',
                        'bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200': activeTab !== 'notification'
                    }" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                    Notification
                </button>
                            <button @click="activeTab = 'analytics'" :class="{
                        'bg-white text-gray-900 shadow-sm dark:bg-white/[0.03] dark:text-white': activeTab === 'analytics',
                        'bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200': activeTab !== 'analytics'
                    }" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                    Analytics
                </button>
                            <button @click="activeTab = 'customers'" :class="{
                        'bg-white text-gray-900 shadow-sm dark:bg-white/[0.03] dark:text-white': activeTab === 'customers',
                        'bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200': activeTab !== 'customers'
                    }" class="inline-flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                    Customers
                </button>
                    </nav>
    ...
    <div class="p-6 pt-4 border border-t-0 border-gray-200 rounded-b-xl dark:border-gray-800">
        <!-- Tab Content -->
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div x-show="activeTab === 'notification'" style="display: none;">
                <h3 class="mb-1 text-xl font-medium text-gray-800 dark:text-white/90">
                    Notification
                </h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div x-show="activeTab === 'analytics'" style="display: none;">
                <h3 class="mb-1 text-xl font-medium text-gray-800 dark:text-white/90">
                    Analytics
                </h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">
    ...
    <div class="border-b border-gray-200 dark:border-gray-800">
        <nav class="-mb-px flex space-x-2 overflow-x-auto [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-200 dark:[&amp;::-webkit-scrollbar-thumb]:bg-gray-600 dark:[&amp;::-webkit-scrollbar-track]:bg-transparent [&amp;::-webkit-scrollbar]:h-1.5">
                            <button class="inline-flex items-center border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap text-blue-500 dark:text-blue-400 border-blue-500 dark:border-blue-400" x-bind:class="activeTab === 'overview' ? 'text-blue-500 dark:text-blue-400 border-blue-500 dark:border-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'overview'">
                    Overview
                </button>
                            <button class="inline-flex items-center border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'notification' ? 'text-blue-500 dark:text-blue-400 border-blue-500 dark:border-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'notification'">
                    Notification
                </button>
                            <button class="inline-flex items-center border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'analytics' ? 'text-blue-500 dark:text-blue-400 border-blue-500 dark:border-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'analytics'">
                    Analytics
                </button>
                            <button class="inline-flex items-center border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'customers' ? 'text-blue-500 dark:text-blue-400 border-blue-500 dark:border-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'customers'">
                    Customers
                </button>
                    </nav>
    </div>
    ...
    <div class="border-b border-gray-200 dark:border-gray-800">
        <nav class="-mb-px flex space-x-2 overflow-x-auto [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-200 dark:[&amp;::-webkit-scrollbar-thumb]:bg-gray-600 dark:[&amp;::-webkit-scrollbar-track]:bg-transparent [&amp;::-webkit-scrollbar]:h-1.5">
                    ...
                    Overview
                            ...
                            <button class="inline-flex items-center gap-2 border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap text-blue-500 border-blue-500 dark:text-blue-400 dark:border-transparen" x-bind:class="activeTab === 'notification' ? 'text-blue-500 border-blue-500 dark:text-blue-400 dark:border-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'notification'">
                    <svg class="size-5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="pt-4 dark:border-gray-800">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div x-show="activeTab === 'notification'" style="">
                <h3 class="mb-1 text-xl font-medium text-gray-800 dark:text-white/90">
                    Notification
                </h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">
    ...
    <div class="border-b border-gray-200 dark:border-gray-800">
        <nav class="-mb-px flex space-x-2 overflow-x-auto [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-200 dark:[&amp;::-webkit-scrollbar-thumb]:bg-gray-600 dark:[&amp;::-webkit-scrollbar-track]:bg-transparent [&amp;::-webkit-scrollbar]:h-1.5">
                            <button class="inline-flex items-center gap-2 border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap text-blue-500 dark:border-blue-400 border-blue-500 dark:text-blue-400" x-bind:class="activeTab === 'overview' ? 'text-blue-500 dark:border-blue-400 border-blue-500 dark:text-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'overview'">
                    Overview
                            ...
                            <button class="inline-flex items-center gap-2 border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'notification' ? 'text-blue-500 dark:border-blue-400 border-blue-500 dark:text-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'notification'">
                    Notification
                                    </button>
                            <button class="inline-flex items-center gap-2 border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'analytics' ? 'text-blue-500 dark:border-blue-400 border-blue-500 dark:text-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'analytics'">
                    Analytics
                                            <span class="inline-block items-center justify-center rounded-full bg-blue-50 px-2 py-0.5 text-center text-xs font-medium text-blue-500 dark:bg-blue-500/15 dark:text-blue-400">
                            4
                        </span>
                                    </button>
                            <button class="inline-flex items-center gap-2 border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'customers' ? 'text-blue-500 dark:border-blue-400 border-blue-500 dark:text-blue-400' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'customers'">
                    Customers
                                            <span class="inline-block items-center justify-center rounded-full bg-blue-50 px-2 py-0.5 text-center text-xs font-medium text-blue-500 dark:bg-blue-500/15 dark:text-blue-400">
                            12
                        </span>
    ...
    <div class="flex flex-col gap-6 sm:flex-row sm:gap-8">
        ...
        <div class="overflow-x-auto pb-2 sm:w-[200px] [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-100 dark:[&amp;::-webkit-scrollbar-thumb]:bg-gray-600 [&amp;::-webkit-scrollbar-track]:bg-white dark:[&amp;::-webkit-scrollbar-track]:bg-transparent [&amp;::-webkit-scrollbar]:h-1.5">
            <nav class="flex w-full flex-row sm:flex-col sm:space-y-2">
                                    <button class="inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3 whitespace-nowrap text-blue-500 dark:bg-blue-400/20 dark:text-blue-400 bg-blue-50" x-bind:class="activeTab === 'overview' ? 'text-blue-500 dark:bg-blue-400/20 dark:text-blue-400 bg-blue-50' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'overview'">
                        Overview
                    </button>
                                    <button class="inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3 whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'notification' ? 'text-blue-500 dark:bg-blue-400/20 dark:text-blue-400 bg-blue-50' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'notification'">
                        Notification
                    </button>
                                    <button class="inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3 whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'analytics' ? 'text-blue-500 dark:bg-blue-400/20 dark:text-blue-400 bg-blue-50' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'analytics'">
                        Analytics
                    </button>
                                    <button class="inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3 whitespace-nowrap bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" x-bind:class="activeTab === 'customers' ? 'text-blue-500 dark:bg-blue-400/20 dark:text-blue-400 bg-blue-50' : 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'" x-on:click="activeTab = 'customers'">
                        Customers
                    </button>
                            </nav>
        </div>
        ...
        <div class="flex-1">
            <div>
                                    <div x-show="activeTab === 'overview'" style="">
                        <h3 class="mb-1 text-xl font-medium text-gray-800 dark:text-white/90">
                            Overview
                        </h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
